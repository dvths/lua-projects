...
function love.load()
    ...
    -- uma linha rápida e fácil para por o titulo na janela
    -- (um leve nível de polimento)
...
function love.draw()
    ...
    -- Chamada da função auxiliar definida logo abaixo
    displayFPS()
...
--[[
    Rnderizando o FPS na tela.
]]
function displayFPS()
    -- um simples display FPS
    love.graphics.setFont(smallFont)
