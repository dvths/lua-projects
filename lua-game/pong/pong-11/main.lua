...
function love.load()
    ...
    -- Inicialize um verdadeiro estilo retrô
    smallFont = love.graphics.newFont('font.ttf', 8)
    largeFont = love.graphics.newFont('font.ttf', 16)
    scoreFont = love.graphics.newFont('font.ttf', 32)
    love.graphics.setFont(smallFont)

    -- Configuração dos efeitos sonoros mais tarde, é possível indexar esta tabela e 
    -- chamar no método `play` de cada entrada.
    sounds = {
