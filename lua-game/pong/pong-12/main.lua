...
function love.load()
    ...
    -- Inicialize a resolução virtual com a possibilidade de redimensionamento (resizable = true)
...
--[[
    Chamado por LÖVE sempre que redimensionamos a tela;  aqui, só queremos pensar na
    largura e altura para empurrar para que a resolução virtual possa ser redimensionada conforme necessário.
]] --
